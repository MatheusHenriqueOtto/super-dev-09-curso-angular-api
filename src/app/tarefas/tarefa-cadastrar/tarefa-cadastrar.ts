...
export class TarefaCadastrar {
  private readonly tarefasService = inject(TarefaService);
  ...
  salvar(): void {
    this.tarefasService.cadastrar(this.tarefa()).subscribe({
      next: () => {
...
// comunicado com api /api/v1/trabalhos/tarefas
// lista Get, cadstro post